...
const LogInModal = ({ openModal, setOpenModal }) => {
    ...
    const onSubmit = (data) => {
        dispatch((0, user_1.loginUser)(Object.assign({}, data)));
    };
    if (isAuthenticated) {
    ...
    return (React.createElement(flowbite_react_1.Modal, { dismissible: true, show: openModal === 'dismissible', size: 'md', onClose: () => setOpenModal(true) },
        React.createElement(flowbite_react_1.Modal.Header, { className: 'bg-' },
            " ",
            React.createElement("h1", { className: "text-2xl" }, "Log in to you account")),
        React.createElement(flowbite_react_1.Modal.Body, null,
            React.createElement("form", { onSubmit: handleSubmit(onSubmit), className: "" },
                React.createElement("div", { className: "mb-6" },
                    React.createElement("label", { htmlFor: "email", className: "block mb-2 text-sm font-medium text-black  dark:text-white" }, "Your email"),
                ...
                React.createElement("div", { className: "mb-6" },
                    React.createElement("label", { htmlFor: "password", className: "block mb-2 text-sm font-medium text-black dark:text-white" }, "Your password"),
                ...
                React.createElement("div", { className: "flex items-start mb-6" },
                    ...
                    React.createElement("label", { htmlFor: "remember", className: "ml-2 text-sm font-medium text-black dark:text-gray-300" }, "Remember me")),
                React.createElement("div", { className: "flex justify-center" },
                    React.createElement("button", { onClick: () => setOpenModal(undefined), type: "button", className: "py-2.5 px-5 mr-2 mb-2 text-sm font-medium  focus:outline-none text-black bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-black-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" }, "Cancel"),
        ...
        React.createElement(flowbite_react_1.Modal.Footer, null, loading ? (React.createElement(LoadingSpinner_1.default, null)) : (React.createElement("div", null,
            React.createElement("div", null,
                React.createElement("span", { className: " text-sm text-black" },
